...
- **Internal/company refs** — Amartha names, internal project names (e.g. `deploy-hermes`),
...
```bash
git diff --cached | grep -inIE 'amartha|deploy-hermes|@(icloud|gmail)\.com|<real-name>' 
```
