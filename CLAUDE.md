...
- [2026-08-07 MCP result overflow continuation](docs/findings/2026-08-07-mcp-result-overflow-continuation.md) — oversized `tools/call` results split into chunks via `continue_tool_result` instead of mid-string truncate; env `MAX_OVERFLOW_PARTS` (default 5, Vault-injectable) caps fetchable parts; `complete: false` when remainder omitted
