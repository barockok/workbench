...
- [2026-05-31 cookie domain scoping](docs/findings/2026-05-31-cookie-domain-scoping.md) — multi-subdomain cookie capture swept in sibling-host + short-lived junk; replaying all cookies to every host → nginx 400 / NextAuth `{}`. Scope cookies to target host (browser-like); liveness = ≥1 live cookie, not "none expired"
