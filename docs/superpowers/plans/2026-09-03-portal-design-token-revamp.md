...
Run: `git log --oneline docs/superpowers/specs/2026-09-03-portal-design-token-revamp-design.md docs/superpowers/plans/2026-09-03-portal-design-token-revamp.md packages/shared/styles/tokens.css | head -1` then `grep -rniE "acme|funds-lite|vercel\.app|A-Partner|internal-app" packages/shared/styles/tokens.css docs/site/assets/docs.css packages/portal/src` (across the whole tree touched by this plan).
