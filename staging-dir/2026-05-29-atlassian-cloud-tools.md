...
| atlassian-confluence| PASS — site picker → `acme-confluence.atlassian.net` | `confluence_search_pages` `{query:"staging"}`         | PASS — real Confluence page `staging` (`id: 6897795134`) |
...
| Tool                  | Result |
|-----------------------|--------|
| `confluence_search_pages` | PASS — real page `staging` (`id: 6897795134`) |
